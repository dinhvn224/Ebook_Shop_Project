                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-login">
                            ...
                            <div class="form-addons">
                                <input name="email" type="email" value="{{ old('email') }}" required autofocus placeholder="Nhập email của bạn">
                        ...
                        <div class="form-login">
                            ...
                            <div class="pass-group">
                                <input name="password" type="password" class="pass-input" required placeholder="Nhập mật khẩu">
