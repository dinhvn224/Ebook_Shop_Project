...
@section('content')
<section style="min-height: 85vh; padding: 24px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); position: relative; overflow: hidden;">
        ...
        <div class="cart-container">
                            ...
                            <tr class="cart-row-3d">
                                ...
                                <td class="td-3d product-info">
                                    <div class="product-card">
                                        ...
                                        <a href="{{ route('book.detail', $item->bookDetail->book->id) }}" target="_blank" class="product-name-3d">
                                ...
                                <td class="td-3d">
                                    <div class="quantity-controls-3d">
                                        <form action="{{ route('cart.update', $item->id) }}" method="POST" class="quantity-form">
                                            @csrf
                                            <button type="submit" formaction="{{ route('cart.update', $item->id) }}?action=decrease" class="btn-3d btn-decrease">
                                                <span>−</span>
                                            </button>
                                            <div class="quantity-display">
                                                <input type="number" name="quantity" value="{{ $item->quantity }}" min="1" max="50" readonly class="quantity-input-3d">
                                            </div>
                                            <button type="submit" formaction="{{ route('cart.update', $item->id) }}?action=increase" class="btn-3d btn-increase">
                                                <span>+</span>
                                            </button>
                                        </form>
                                    </div>
            ...
            <div class="cart-summary-3d">
                ...
                <div class="cart-actions-3d">
                    <button class="btn-3d btn-checkout" disabled>
...
<style>
    * {
    ...
    @keyframes float {
        0%, 100% { transform: translateY(0px) perspective(1000px) rotateX(45deg) rotateY(45deg); }
        50% { transform: translateY(-20px) perspective(1000px) rotateX(45deg) rotateY(45deg); }
    }
    ...
    .price-tag:hover, .subtotal-amount:hover {
